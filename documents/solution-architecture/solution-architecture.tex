   ...
   \date{\today}
    ...
    \begin{table}[H]
        ...
        \begin{tabularx}{\textwidth}{l l l l l l l}
            ...
            1 & 19-02-20 & 04-03-20 & M1 & Vision definiert. & 80 & 103 \\
            &&&& Geschäftsmodel definiert. && \\
            &&&& Anwendungsfälle definiert, Priorisierung vorgenommen. && \\
            &&&& Wichtigste nicht-funktionalen Anforderungen definiert. && \\
            &&&& Recherche zu Technologien angestellt. && \\
            &&&& Projektskizze erstellen. && \\

            \toprule
            Elaboration &&&&&& \\

            2 & 04-03-20 & 25-03-20 & M2 & Weitere Technologie-Recherchen vornehmen. & 80 & 74 \\
            &&&& PoC Spiel spielen. Systemarchitektur definieren. && \\ 
            &&&& Domänenmodell erstellen. && \\
            &&&& Entwicklungsumgebung aufsetzen. && \\
            &&&& Github Workflow, Continuous Integration einrichten. \\

            3 & 25-03-20 & 08-04-20 & M2 & Implementation Systemarchitektur. & 120 & 159 \\
            &&&& Frontend Spiel spielen. && \\
            &&&& Frontend Webseite Grundstruktur. && \\
            &&&& Datenbank Setup und Anbindung. && \\
            &&&& Gameserver modularisiert und stabilisiert. && \\
            
            \toprule
            Construction &&&&&& \\

            4 & 08-04-20 & 22-04-20 & M3 & Implementation Spielregeln. & 100 & \\
            &&&& Implementation Spiel generieren && \\
            &&&& Implementation Spiel auswählen. && \\
