...
wird zum Login-Screen weitergeleitet.
	...
	Die Sprache wird grundsätzlich versucht in Englisch zu halten um Sprachprobleme so gut wie möglich zu vermeiden.
    ...
    \section{Design-Artefakte}
        ...
        \subsection{UML Klassendiagramme}
            ...
            % TODO: Game Server Modul-Diagramm hier!
            \label{fig:GameServerModulDiagramm}

            \begin{figure}[H]
                \centering
                \makebox[\textwidth][c]{\includegraphics[width=1.1\textwidth]{figures/UML class diagrams/Package appmain light.png}}
