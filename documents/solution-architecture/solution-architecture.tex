...
\begin{document}
   ...
   \date{\today}
	...
	\end{figure}
	\subsection{Login und Gastaccount}
		Der Spieler hat die Freiheit sich mit einem anonymen Gastaccount  oder mit einem registrierten Account anzumelden. Der Spieler kann sich in der Applikation nicht mit beiden Kontoarten gleichzeitig identifizieren.
    ...
    \begin{table}[H]
        ...
        \begin{tabularx}{\textwidth}{l l l l}
            ...
            Prototyp Spiel spielen & 10 & 20 & Holenstein \\
            Frontend Mockup & 5 & 7 & Iten \\
            Frontend Prototyp & 10 & 14 & Iten \\
            Game Server Stabilisierung & 15 & 20 & Holenstein \\
