   ...
   \date{\today}
    ...
    \section{Design-Artefakte}
        ...
        \subsection{UML Klassendiagramme}
            ...
            \begin{figure}[H]
                \centering
                \makebox[\textwidth][c]{\includegraphics[width=1.1\textwidth]{figures/UML class diagrams/Package game dark.png}}
                \caption{UML class diagrams - Package game}
                \label{fig:UMLclassdiagram_Packagegame}
            \end{figure}
            \newpage
            \begin{figure}[H]
                \centering
