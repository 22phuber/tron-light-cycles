...
\begin{document}
   ...
   \date{\today}
    ...
    \label{sec:Softwarearchitektur}
        ...
        \begin{figure}[H]
            \centering
            \makebox[\textwidth][c]{\includegraphics[width=1\textwidth]{figures/Tron_basic_architecture.png}}
            \caption{Abstrahierte Softwarearchitektur - Tron Licht-Motorräder Computerspiel}
            \label{fig:basicArchitecture_TronLightCycles}
         \end{figure}
        ...
        \label{ssec:SoftwarearchitekturGameClient}
        ...
        Nachfolgend eine detailierte Darstellung der Architektur des Gesamtsystems:
        \begin{figure}[H]
            \includegraphics[scale=0.4]{figures/architecture-draft_v3.png}
            \caption{Detailierte Softwarearchitektur}
        \end{figure}
        \newpage
        ...
        \subsection{UML Moduldiagramm}
            \label{fig:GameServerModulDiagramm}
             \begin{figure}[H]
                ...
                \caption{UML module dependency diagram - Game Server}
            \end{figure}
    ...
    \subsection{Spieleclient (Game Client)}
    Wie schon in \hyperref[ssec:SoftwarearchitekturGameClient]{Abschnitt Softwarearchitektur, Unterabschnitt Spieleclient} erläutert, ist der Spieleclient momentan in zwei \Gls{React}-Komponenten aufgeteilt. Eine Komponte kümmert sich um die \textbf{Animation} und kommuniziert direkt mit dem \hyperref[ssec:ImplementationGameServer]{Game Server} über eine \Gls{Websocket}-Verbindung. Die Animation braucht die gesendeten Daten des Servers, liest und interpretiert den Inhalt und schickt eine Teil der Daten an die zweite Komponente.\newline
    Die zweite Komponente ist - einfach ausgedrückt - für das Zeichen der Spielerdaten, Hindernisse und des Spielfeldes im \Gls{Webbrowser} verantwortlich. Dazu wird das \Gls{HTML5 Canvas} Element verwendet und mit einer speziellen \Gls{React}-Referenz \href{https://reactjs.org/docs/refs-and-the-dom.html}{\inlinecode{Java}{React.createRef();}} versehen . Diese Referenz, erlaubt eine schnelle Manipulation des Elementes ohne, alle involvierten  Komponenten, neu rendern zu müssen, es ist eine Art Abkürzung und den normalen \Gls{React}-Ablauf  zu umgehen.\newline
    Die zwei Komponenten müssen in der nächsten Iteration in mind. Drei aufgeteilt werden. Nach Codierungsrichtlinien und \quotes{Best Practices}, sollte auch die  \Gls{Websocket}-Kommunikation in eine eigene Komponente verschoben werden.

    \subsection{\Gls{Game Server}}
    \label{ssec:ImplementationGameServer}
    ...
    \begin{figure}[H]
        \centering
        \makebox[\textwidth][c]{\includegraphics[width=0.8\textwidth]{figures/erm.png}}
        \caption{Datenbank  ERM - Tron Licht-Motorräder Computerspiel}
        \label{fig:DatabaseERM}
    \end{figure}
    ...
    \begin{table}[H]
        ...
        \begin{tabularx}{\textwidth}{l l l l X}
            \toprule
            Iterations Nr. & Start & Ende & Meilenstein & Ziele \\
            \toprule
            Inception &&&& \\

            1 & 19-02-20 & 04-03-20 & M1 & Vision definiert. Geschäftsmodell definiert. Anwendungsfälle definiert und Priorisierung vorgenommen. Wichtigste nicht-funktionalen Anforderungen definiert. Recherche zu Technologien angestellt. Projektskizze erstellen. \\

            \toprule
            Elaboration &&&& \\

            2 & 04-03-20 & 25-03-20 & M2 & Weitere Technologie-Recherchen vornehmen. PoC Spiel spielen. Systemarchitektur definieren. Domänenmodell erstellen. Entwicklungsumgebung aufsetzen. Github Workflow, Continuous Integration einrichten. \\

            3 & 25-03-20 & 08-04-20 & M2 & Implementation Systemarchitektur. Frontend Spiel spielen. Frontend Webseite Grundstruktur. Datenbank Setup und Anbindung. Gameserver modularisiert und stabilisiert. \\

            \toprule
            Construction &&&&\\

            4 & 08-04-20 & 22-04-20 & M3 & Implementation Spielregeln. Implementation Spiel generieren. Implementation Spiel auswählen. \\

            5 & 22-04-20 & 06-05-20 & M3 & \\

            6 & 06-05-20 & 20-05-20 & M3 & \\
            \toprule
        \end{tabularx}
    ...
    \subsection{Risiken}
    Das in der Projektskizze erwähnte Risiko bezüglich der graphischen Umsetzung des Spiels konnte relativiert werden. Momentan sind keine grösseren Risiken vorhanden.
    % Appendix after this
     \newpage
