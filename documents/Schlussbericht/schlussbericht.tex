...
%− Dokumentation wichtiger Architekturaspekte, Designentscheide und angewendeter Design Patterns
    ...
    \begin{figure}[H]
    	\centering
    	\makebox[\textwidth][c]{\includegraphics[scale=0.3]{figures/Tron_basic_architecture.png}}
    	\caption{Systemarchitektur}
    	\label{fig:Systemarchitecture}
    \end{figure}

	In dieser Abbildung ist die Kommunikation zwischen den Systemen detaillierter beschrieben.
	\begin{figure}[H]
		\centering
		\makebox[\textwidth][c]{\includegraphics[scale=0.3]{figures/architecture-draft_v3.png}}
		\caption{Systemarchitektur mit Kommunikation}
		\label{fig:Systemarchitecture_Communication}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\makebox[\textwidth][c]{\includegraphics[scale=0.3]{figures/gameserver-uml/appmain-classes.png}}
		\caption{Startpunkt}
	...
	\begin{figure}[H]
		\centering
		\makebox[\textwidth][c]{\includegraphics[scale=0.3]{figures/gameserver-uml/modules.png}}
		\caption{Die drei Module}
		\label{fig:modules}
	\end{figure}

	\begin{figure}[H]
		\centering
		\makebox[\textwidth][c]{\includegraphics[scale=0.3]{figures/gameserver-uml/transport-classes.png}}
		\caption{Das Transport Modul}
		\label{fig:transport_module}
	\end{figure}
	
	\begin{figure}[H]
		\centering
		\makebox[\textwidth][c]{\includegraphics[scale=0.2]{figures/gameserver-uml/middleman-classes.png}}
		\caption{Das Middleman Modul}
		\label{fig:middleman_module}
	\end{figure}
	
	\begin{figure}[H]
		\centering
		\makebox[\textwidth][c]{\includegraphics[scale=0.3]{figures/gameserver-uml/game-classes.png}}
		\caption{Das Game Modul}
		\label{fig:game_module}
	\end{figure}
