...
%− Testkonzept: Zusammenfassung des gedockermachten Tests (Unit-, Integrations- und System- tests) und Testresultate
...
%• Jede Klasse und alle öffentlichen Methoden und Attribute müssen (kurz) mittels JavaDoc dokumentiert werden. Der fertige JavaDoc-Kommentar muss ebenfalls (elektronisch) ab- gegeben werden.
    ...
    \begin{figure}[H]
        \centering
        \makebox[\textwidth][c]{\includegraphics[scale=0.45]{figures/GHActions_01.png}}
