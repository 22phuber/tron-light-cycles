...
%• Jede Klasse und alle öffentlichen Methoden und Attribute müssen (kurz) mittels JavaDoc dokumentiert werden. Der fertige JavaDoc-Kommentar muss ebenfalls (elektronisch) ab- gegeben werden.
	...
	Beim Gameserver werden sämmtliche Klassen des Moduls Game mit Unit Tests getestet. Hauptsächlich wird geprüft, dass die korrekten Werte gesetzt, zurück gegeben und berechnet werden.
	\begin{figure}[H]
		\centering
    ...
    \begin{figure}[H]
        \centering
        \makebox[\textwidth][c]{\includegraphics[scale=0.48]{figures/GHActions_01.png}}
