...
%− Dokumentation wichtiger Architekturaspekte, Designentscheide und angewendeter Design Patterns
	...
	\centering \textit player.x - client.x + ( width / 2 )
	...
	\centering \includegraphics[scale=0.5]{figures/battleroyale_rendering1.png} \includegraphics[scale=0.5]{figures/battleroyale_rendering2.png}
