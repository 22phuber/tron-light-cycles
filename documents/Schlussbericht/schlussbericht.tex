...
%− Ausblick auf mögliche Weiterentwicklungen
	...
	\begin{itemize}
        \item Backend [Node.js]: Speichern der erreichten Punkte in der Datenbank
        \item Frontend [React]: \quotes{My Account} Implementation
        \item Frontend [React]: Speichern des Authentifizierungstokens (JWT) im Memory
         \item Frontend [React]: \Glspl{Sprite} einsetzen, z.B. für das \quotes{Licht-Motorrad} im \Gls{Canvas} (HTML-Element)
        \item Backend [Node.js]:  Api Endpoint und Evaluierung des Authentifizierungstokens (JWT) für \quotes{My Account} Anfragen.
	\end{itemize}
