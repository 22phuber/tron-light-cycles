...
%%% Projektidee
    ...
    Einnahmen werden hauptsächlich durch Werbeanzeigen generiert. Genaue Berechnungen gestallten sich relativ schwierig, da sich die Besucheranzahl auf der Webseite über die Zeit ändern kann. Ausserdem sind die Einnahmen abhängig von der Bezahlstrategie und davon, wie stark der Inhalt der angezeigten Werbung den jeweiligen Webseitenbesucher anspricht\cite{CPCVsCPA2019}\cite{daswani2008online}. \\
    \\
...
%− Dokumentation wichtiger Architekturaspekte, Designentscheide und angewendeter Design Patterns
    ...
    Abstrakter Überblick der Softwarearchitektur. \Gls{NGiNX} ist Webserver für den statischen Inhalt und \Gls{Reverse-Proxy} für GamerServer und Node.js Backend Anfragen, siehe \autoref{fig:Softwarearchitektur_abstract} .
        \begin{figure}[H]
        \centering
        \makebox[\textwidth][c]{\includegraphics[width=0.9\textwidth]{figures/Tron_basic_architecture.png}}
    ...
    \begin{figure}[H]
        \centering
        \makebox[\textwidth][c]{\includegraphics[scale=0.4]{figures/SSD_GameProcedure.png}}
    ...
    Die Material-UI Sammlung \url{https://material-ui.com/} der \Gls{React} Komponenten erlaubt uns, fertige Komponenten einzusetzen ohne diese selber entwickeln zu müssen. Dies bedeutet eine schnellere Entwicklung mit schon ausgereiften Komponenten welche schon in etlichen anderen Applikationen eingesetzt wurden.
...
%• Jede Klasse und alle öffentlichen Methoden und Attribute müssen (kurz) mittels JavaDoc dokumentiert werden. Der fertige JavaDoc-Kommentar muss ebenfalls (elektronisch) ab- gegeben werden.
	...
	\begin{figure}[H]
		\centering
		\makebox[\textwidth][c]{\includegraphics[scale=0.5]{figures/lobby_unit_tests.png}
		\caption{Ausschnitt aus den Unit Tests für die Klasse Lobby}
		\label{fig:lobby unit tests}
	\end{figure}
